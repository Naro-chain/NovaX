      ...
      <div className="default-container DashboardV2 page-layout">
        ...
        <div className="DashboardV2-content">
                ...
                <div className="App-card-row dashboard">
                  ...
                  <div>
                    <TooltipComponent
                      ...
                      position="right-bottom"
                      renderContent={() => (
                        <span>{t`Assets Under Management: NVX staked (All chains) + ULP pool (${chainName}).`}</span>
                      )}
                    />
                  </div>
                </div>
          ...
          <div className="Tab-title-section">
            ...
            <div className="Page-description">
              <Trans>NVX and ULP tokens stats.</Trans>
            </div>
          </div>
                    ...
                    <div className="App-card-title-mark dashboard">
                      <div className="App-card-token-title-left">
                        <div className="App-card-title-mark-icon">
                          <img src={dashboard_utx_icon} width="40" alt="NVX Token Icon" />
                        </div>
                        <div className="App-card-title-mark-info">
                          <div className="App-card-title-mark-title">NVX</div>
                        </div>
                      </div>
                  ...
                  <div className="App-card-content-wrapper">
                    ...
                    <div className="App-card-content dashboard">
                      ...
                      <div className="App-card-row dashboard">
                        ...
                        <div>{formatAmount(totalUtxSupply, UTX_DECIMALS, 0, true)} NVX</div>
                      </div>
                      <div className="App-card-row dashboard">
                        <div className="label">
