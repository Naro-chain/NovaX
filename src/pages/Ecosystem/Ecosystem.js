...
export default function Ecosystem() {
  const utxPages = [
    {
      title: "NVX Governance",
      link: "https://gov.utx.io/",
      linkLabel: "gov.utx.io",
      about: t`NVX Governance Page`,
      chainIds: [ARBITRUM],
    },
    {
      title: "NVX Stats",
    ...
    },
    {
      ...
      about: t`NVX Proposals Voting page`,
      chainIds: [ARBITRUM],
    },
    {
      title: "NVX Announcements",
      link: "https://t.me/GMX_Announcements",
      linkLabel: "t.me",
      about: t`NVX Announcements and Updates`,
      chainIds: [ARBITRUM],
    },
  ];
  ...
  const communityProjects = [
    ...
    },
    {
      ...
      linkLabel: "t.me",
      about: t`Telegram bot for NVX Swaps monitoring`,
      creatorLabel: "@snipermonke01",
      creatorLink: "https://twitter.com/snipermonke01",
      chainIds: [ARBITRUM],
    },
    {
      title: "NVX Position Calculator",
  ...
  const dashboardProjects = [
    {
      title: "NVX Referrals Dashboard",
      link: "https://www.gmxreferrals.com/",
      linkLabel: "gmxreferrals.com",
      about: t`Dashboard for NVX referral stats`,
      creatorLabel: "@kyzoeth",
      creatorLink: "https://twitter.com/kyzoeth",
      chainIds: [ARBITRUM],
    },
    {
      ...
      about: t`NVX explorer for stats and traders`,
    ...
    {
      title: "NVX Open Trades Ranking and Stats",
    ...
    {
      title: "NVX Everything Dashboard",
  ...
  const integrations = [
    ...
    },
    {
      ...
      linkLabel: "beefy.com",
      about: t`ULP and NVX autocompounding vaults`,
      ...
      <div className="default-container page-layout">
        <div>
          <div className="section-title-block">
            ...
            <div className="section-title-content">
              <div className="Page-title">
                <Trans>NVX Pages</Trans>
              </div>
              <div className="Page-description">
                <Trans>NVX ecosystem pages.</Trans>
              </div>
            </div>
          </div>
          ...
          <div className="Tab-title-section">
            ...
            <div className="Page-description">
              <Trans>
                Projects developed by the NVX community. <br />
          ...
          <div className="Tab-title-section">
            ...
            <div className="Page-description">
              <Trans>NVX dashboards and analytics.</Trans>
            </div>
          </div>
          <div className="DashboardV2-projects">
          ...
          <div className="Tab-title-section">
            ...
            <div className="Page-description">
              <Trans>Projects integrated with NVX.</Trans>
            </div>
          </div>
          <div className="DashboardV2-projects">
