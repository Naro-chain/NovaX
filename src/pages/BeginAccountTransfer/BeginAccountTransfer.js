...
export default function BeginAccountTransfer(props) {
  ...
  const getError = () => {
    ...
    if (hasVestedUtx) {
      return t`VestedNVTX not withdrawn`;
    }
    if (hasVestedUlp) {
      ...
      <div className="Page-title-section">
        ...
        <div className="Page-description">
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            <div>- This will transfer all your NVX, esNVX, ULP and Multiplier Points to your new account.</div>

            <div>- Transfers are only supported if the receiving account has not staked NVX or ULP tokens before.</div>
            <div>
        ...
        <div className="input-form">
          ...
          <div className="BeginAccountTransfer-validations">
            <ValidationRow isValid={!hasVestedUtx}>
              <Trans>Sender has withdrawn all tokens from NVX Vesting Vault</Trans>
            </ValidationRow>
            ...
            <ValidationRow isValid={!hasStakedUtx}>
              <Trans>Receiver has not staked NVX tokens before</Trans>
            </ValidationRow>
