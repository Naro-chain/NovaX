        ...
        {isArbitrum && (
          <div>
            <div className="Page-description">
              ...
              <br />
              <br />
              <Trans>The address of the esNVX (IOU) token is {esUtxIouAddress}.</Trans>
              <br />
              <Trans>
                The esNVX (IOU) token is transferrable. You can add the token to your wallet and send it to another
              ...
              <br />
              <Trans>
                After claiming, the esNVX tokens will be airdropped to your account on the selected network within 7
                days.
              </Trans>
              <br />
              <Trans>The esNVX tokens can be staked or vested at any time.</Trans>
              <br />
              <Trans>
                Your esNVX (IOU) balance will decrease by your claim amount after claiming, this is expected behaviour.
              </Trans>
              <br />
              <Trans>
            ...
            {!error && (
              <div className="muted">
                <Trans>
                  You can currently vest a maximum of {formatAmount(maxVestableAmount, 18, 2, true)} esNVX tokens at a
                  ratio of {formatAmount(currentRatio, 4, 2, true)} {stakingToken} to 1 esNVX.
                </Trans>
                ...
                <Trans>
                  ...
                  esNVX at a ratio of {formatAmount(nextRatio, 4, 2, true)} {stakingToken} to 1 esNVX.
                </Trans>
