      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">NVX</div>
          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to NVX.io ("we," "us," or "our"), the informational resource for NVX Protocol, as defined below.
              </p>
              <p className="body-text">
                NVX.io provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the NVX Protocol (the "NVX Protocol," "Protocol," or "NVX DApp"). NVX.io is not an
                available access point to the NVX Protocol.
              </p>
              <p className="body-text">
                ...
                and conditions by which you may access NVX.io ("the Site") and app.NVX.io ("the Interface"). Please do
              ...
              <ul className="list-style-none">
                <li>
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That NVX.io is not responsible for the operation of the open-source software and networks
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither NVX.io nor any other person or entity will be able to retrieve
                ...
                <li>
                  <p className="body-text">
                    6.2. NVX.io is not responsible for the content of any third party, including, but not limited to,
                    information, materials, products, or services that NVX.io does not own or control. In addition,
                    third parties may offer promotions related to your access and use of the Interface. NVX.io does not
                    ...
                    You expressly relieve NVX.io of all liability arising from using such resources or participating in
                    such promotions.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that NVX.io will have no responsibility or liability for the risks
                    in Section 9. You hereby irrevocably waive, release and discharge all claims, whether known or
                    unknown to you, against NVX.io, its affiliates, and their respective shareholders, members,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of NVX.io;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, includinNVX.io's collaborator and
                        service providers;
                      </p>
                    </li>
                    <li>
            ...
            <div className="section">
              ...
              <p className="body-text">
                NVX.io is an informational site for the NVX Protocol. NVX.io does not operate an exchange platform or
              ...
              <p className="body-text">
                You understand that NVX.io is not registered or licensed by any regulatory agency or authority. No such
                agency or authority has reviewed or approved the use of the Site or the Interface.
              </p>
              <p className="body-text">
                You agree that the Site and the Interface are provided on an "AS IS" and "AS AVAILABLE" basis. NVX.io
            ...
            <div className="section">
              ...
              <p className="body-text">
                In no event shall NVX.io, its affiliates, its suppliers and contractors, and its affiliates', suppliers'
                ...
                or the Interface, or other item provided by or on behalf of NVX.io, whether under contract, tort
                ...
                or any limited remedy hereunder nor is NVX.io in any way responsible for the execution or settlement of
                transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall NVX.io's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless NVX.io, its affiliates, members, member, managers,
            ...
            <div className="section">
              ...
              <p className="body-text">
                NVX.io will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to NVX.io on any of our official channels. The notice must (a) describe the nature and
                basis of the claim and (b) set forth the specific relief sought. Our notice to you will be similar in
                form to that described above. If you and NVX.io cannot reach an agreement to resolve the claim within
                sixty (60) days of your email, then you and NVX.io agree to resolve the potential dispute according to
              ...
              <p className="body-text">
                ...
                year after such claim arose; otherwise, the claim is permanently barred, which means that you and NVX.io
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of NVX.io set forth in these Terms is in addition to, and not in lieu of,
                    any other right or remedy whether described in these Terms, under Applicable Law, at law, or in
                    equity. The failure or delay of NVX.io in exercising any right, power, or privilege under these
                ...
                <li>
                  <p className="body-text">
                    13.4. NVX.io will have no responsibility or liability for any failure or delay in performance of the
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and NVX.io and supersede all prior and
            ...
            <div className="section">
              ...
              <p className="body-text">
                If you have any questions about these Terms, the Site, or the Interface, please get in touch with NVX.io
