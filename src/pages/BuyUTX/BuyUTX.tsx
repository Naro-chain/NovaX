        ...
        <div className="section-title-block">
          <div className="section-title-content">
            <div className="Page-title">
              <Trans>Buy NVX on {getChainName(chainId)}</Trans>
            </div>
  ...
  return (
    <Card title={t`Buy UTX from Decentralized Exchange`}>
      <div className="App-card-content">
        ...
        <div className="exchange-info-group">
          <div className="BuyUTXULP-description fz-base fw-400 text-secondary">
            <Trans>Buy NVX using Decentralized Exchange Aggregators:</Trans>
          </div>
        ...
        <div className="exchange-info-group">
          <div className="BuyUTXULP-description fz-base fw-400 text-secondary">
            <Trans>Buy NVX from Cross-chain Swap:</Trans>
          </div>
          <div className="buttons-group">
        ...
        {isArbitrum && (
          <div className="exchange-info-group">
            <div className="BuyUTXULP-description fz-base fw-400 text-secondary">
              <Trans>NVX bonds can be bought on Bond Protocol with a discount and a small vesting period:</Trans>
            </div>
            <div className="buttons-group col-1">
              <Button
                variant="secondary"
  ...
  return (
    <Card title={t`Buy UTX from Centralized Services`}>
      <div className="App-card-content">
        <div className="exchange-info-group">
          <div className="BuyUTXULP-description fz-base fw-400 text-secondary">
            <Trans>Buy NVX from centralized exchanges:</Trans>
          </div>
          <div className="buttons-group">
        ...
        <div className="exchange-info-group">
          <div className="BuyUTXULP-description fz-base fw-400 text-secondary">
            <Trans>Buy NVX using FIAT gateways:</Trans>
          </div>
