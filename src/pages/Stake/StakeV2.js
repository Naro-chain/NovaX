...
import earn_esutx_icon from "img/dashboard_nvx_icon.png";
import dashboard_ulp_icon from "img/dashboard_ulp_icon.svg";
import dashboard_utx_icon from "img/dashboard_nvx_icon.png";
        ...
        <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title} className="non-scrollable">
          ...
          <div className="VesterDepositModal-info-rows">
            <div className="Exchange-info-row">
              ...
              <div className="align-right">{formatAmount(balance, 18, 2, true)} esNVX</div>
            </div>
            <div className="Exchange-info-row">
              <div className="Exchange-info-label">
                    ...
                    return (
                      <div>
                        ...
                        <StatsTooltipRow
                          showDollar={false}
                          label={t`Deposited`}
                          value={`${formatAmount(vestedAmount, 18, 2, true)} esNVX`}
                        />
                        <StatsTooltipRow
                          showDollar={false}
                          label={t`Max Capacity`}
                          value={`${formatAmount(maxVestableAmount, 18, 2, true)} esNVX`}
                        />
                      </div>
                    );
                  }}
                        ...
                        {amount && nextReserveAmount.gt(maxReserveAmount) && (
                          <>
                            ...
                            <Trans>
                              ...
                              {stakeTokenLabel} to vest {formatAmount(amount, 18, 2, true)} esNVX.
                            </Trans>
                          </>
                        )}
                      </>
      ...
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        <Trans>
          <div>
            ...
            <br />
            <br />
            esNVX tokens that have been converted to NVX will remain as NVX tokens.
            <br />
            <br />
            To claim NVX tokens without withdrawing, use the "Claim" button under the Total Rewards section.
            <br />
            <br />
          </div>
        </Trans>
        ...
        <div className="CompoundModal-menu">
          ...
          <div>
            <Checkbox isChecked={shouldClaimUtx} setIsChecked={setShouldClaimUtx} disabled={shouldStakeUtx}>
              <Trans>Claim NVX Rewards</Trans>
            </Checkbox>
          </div>
          <div>
            <Checkbox isChecked={shouldStakeUtx} setIsChecked={toggleShouldStakeUtx}>
              <Trans>Stake NVX Rewards</Trans>
            </Checkbox>

            <div style={{ color: "var(--text-secondary" }}>
              {formatKeyAmount(processedData, "totalVesterRewards", 18, 4, true)} NVX ($
          ...
          <div>
            <Checkbox isChecked={shouldClaimEsUtx} setIsChecked={setShouldClaimEsUtx} disabled={shouldStakeEsUtx}>
              <Trans>Claim esNVX Rewards</Trans>
            </Checkbox>
          </div>
          <div>
            <Checkbox isChecked={shouldStakeEsUtx} setIsChecked={toggleShouldStakeEsUtx}>
              <Trans>Stake esNVX Rewards</Trans>
            </Checkbox>

            <div style={{ color: "var(--text-secondary" }}>
              {formatKeyAmount(processedData, "totalEsUtxRewards", 18, 4, true)} esNVX ($
...
export default function StakeV2({ setPendingTxns, connectWallet }) {
  ...
  const showStakeUtxModal = () => {
    ...
    setStakeModalTitle(t`Stake NVX`);
    setStakeModalMaxAmount(processedData.utxBalance);
    setStakeValue("");
    setStakingTokenSymbol("NVX");
  ...
  const showStakeEsUtxModal = () => {
    setIsStakeModalVisible(true);
    setStakeModalTitle(t`Stake esNVX`);
    setStakeModalMaxAmount(processedData.esUtxBalance);
    setStakeValue("");
    setNativeToken(false);
    setStakingTokenSymbol("esNVX");
  ...
  const showUtxVesterDepositModal = () => {
    ...
    setVesterDepositStakeTokenLabel("staked NVX + esNVX + Multiplier Points");
  ...
  const showUnstakeEsUtxModal = () => {
    setIsUnstakeModalVisible(true);
    setNativeToken(false);
    setUnstakeModalTitle(t`Unstake esNVX`);
  ...
  if (totalRewardTokensAndUlp && totalRewardTokensAndUlp.gt(0)) {
    ...
    if (processedData.esUtxInStakedUtx && processedData.esUtxInStakedUtx.gt(0)) {
      esUtxAmountStr = formatAmount(processedData.esUtxInStakedUtx, 18, 2, true) + " esNVX";
    }
    let mpAmountStr;
    ...
    <div className="default-container page-layout">
      ...
      <div className="section-title-block">
        ...
        <div className="section-title-content">
          ...
          <div className="Page-description" style={{ color: "var(--text-secondary)" }}>
            <Trans>
              Stake <ExternalLink href="https://utxio.gitbook.io/utx/tokenomics">NVX</ExternalLink> and{" "}
      ...
      <div className="StakeV2-content">
        <div className="StakeV2-cards asset-and-reward">
          <div className="App-card StakeV2-utx-card Asset">
            <div className="App-card-title">Your NovaX Asset</div>
            <div className="App-card-content stake">
              <div className="App-card-row-session-wrapper">
                ...
                <div className="App-card-row-stake-wrapper">
                  <div className="App-card-row stake">
                    <div className="label">
                      <Trans>NVX in Wallet</Trans>
                    </div>
                    <div>
                      {formatKeyAmount(processedData, "utxBalance", 18, 2, true)} NVX{" "}
                  ...
                  <div className="App-card-row stake">
                    <div className="label">
                      <Trans>NVX Staked</Trans>
                    </div>
                    <div>
                      {formatKeyAmount(processedData, "utxInStakedUtx", 18, 2, true)} NVX{" "}
                      <span style={{ color: "var(--text-secondary" }}>
                        ($
              ...
              <div className="App-card-row-session-wrapper">
                ...
                <div className="App-card-row-stake-wrapper">
                  <div className="App-card-row stake">
                    <div className="label">
                      <Trans>esNVX in Wallet</Trans>
                    </div>
                    <div>
                      {formatKeyAmount(processedData, "esUtxBalance", 18, 2, true)} esNVX{" "}
                      <span style={{ color: "var(--text-secondary" }}>
                        ($
                  ...
                  <div className="App-card-row stake">
                    <div className="label">
                      <Trans>esNVX Staked</Trans>
                    </div>
                    <div>
                      {formatKeyAmount(processedData, "esUtxInStakedUtx", 18, 2, true)} esNVX{" "}
                      <span style={{ color: "var(--text-secondary" }}>
                        ($
          ...
          <div className="App-card primary StakeV2-total-rewards-card">
            <div className="App-card-title">
              <Trans>Your NovaX Rewards</Trans>
            </div>
            <div className="App-card-content stake">
              ...
              <div className="App-card-row-session-wrapper">
                ...
                <div className="App-card-row-stake-wrapper">
                  <div className="App-card-row stake">
                    <div className="label">Escrowed NVX</div>
                    <div>
        ...
        <div className="StakeV2-cards stake-and-unstake">
            ...
            <div className="StakeV2-utx-card-container">
              <div>
                <div className="App-card-title fw-600 text-primary">
                  <Trans>Stake NVX</Trans>
                </div>
                <div className="text-secondary fz-base fw-400">Earn esNVX & U2U</div>
              </div>
          ...
          <div className="App-card StakeV2-utx-card stake-and-unstake">
            <div className="StakeV2-utx-card-container">
              <div>
                <div className="App-card-title fw-600 text-primary">
                  <Trans>Stake esNVX</Trans>
                </div>
                <div className="text-secondary fz-base fw-400">Earn esNVX</div>
              </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                  ...
                  <div className="App-card-row stake">
                    ...
                    <div>
                      ...
                      {totalUtxStaked && (
                        <div style={{ display: "flex", flexDirection: "column" }}>
                          {formatKeyAmount(processedData, "stakedEsUtxSupply", 18, 0, true) + " esNVX"}
                          <span className="label text-secondary">
                  ...
                  <div className="App-card-row stake">
                    ...
                    {totalUtxSupply && (
                      <div style={{ display: "flex", flexDirection: "column" }}>
                        {formatAmount(esUtxSupply, 18, 0, true) + " esNVX"}
                        <span className="label text-secondary">
      ...
      <div>
        <div className="Tab-title-section">
          ...
          <div className="Page-description fz-base fw-400 text-secondary">Convert esNVX tokens to NVX tokens.</div>
        </div>
        <div>
          <div className="StakeV2-cards">
            ...
            >
              ...
              >
                <div>
                  <div className="App-card-title fw-600 text-primary">
                    <Trans>NVX Vault</Trans>
                  </div>
                  <div className="text-secondary fz-base fw-400">esNVX to NVX</div>
                </div>
                ...
                >
                  ...
                  <div>
                    <Tooltip
                      ...
                      handle={`${formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} NVX`}
                      position="right-bottom"
                      renderContent={() => (
                        <Trans>
                          {formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} NVX tokens can be claimed,
                        ...
                        return (
                          <div>
                            <Trans>
                              ...
                              converted to NVX from the{" "}
                              {formatKeyAmount(vestingData, "gmxVesterVestedAmount", 18, 4, true)} esNVX deposited for
                              vesting.
                            </Trans>
                          </div>
                        );
            ...
            >
              ...
              >
                <div>
                  ...
                  <div className="text-secondary fz-base fw-400">esNVX to ULP</div>
                </div>
                <img src={vestUtx} alt="vest utx" />
              </div>
              <div
                        ...
                        return (
                          <div>
                            <Trans>
                              ...
                              {formatKeyAmount(vestingData, "glpVesterVestedAmount", 18, 4, true)} esNVX deposited for
                              vesting.
                            </Trans>
                          </div>
                        );
