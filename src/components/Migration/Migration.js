        ...
        <div className="MigrationModal-info-box">
          <div className="App-info-row">
            ...
            <div className="align-right">
              {baseAmount &&
                `${formatAmount(baseAmount, 18, 4, true)} NVX ($${formatAmount(
                  baseAmountUsd,
                  18 + decimals,
                  2,
                  true
          ...
          {token.bonus > 0 && (
            <div className="App-info-row">
              ...
              <div className="align-right">
                {bonusAmount &&
                  `${formatAmount(bonusAmount, 18, 4, true)} NVX ($${formatAmount(
                    bonusAmountUsd,
                    18 + decimals,
                    2,
                    true
          ...
          {token.bonus > 0 && (
            <div className="App-info-row">
              ...
              <div className="align-right">
                {totalAmount &&
                  `${formatAmount(totalAmount, 18, 4, true)} NVX ($${formatAmount(
                    totalAmountUsd,
                    18 + decimals,
                    2,
                    true
  ...
  return (
    <div className="Migration Page">
      ...
      <div className="Migration-note">
        <Trans>Your wallet: {formatAmount(utxBalance, 18, 4, true)}</Trans> NVX
      </div>
