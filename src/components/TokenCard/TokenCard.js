...
import utxLogo from "img/dashboard_nvx_icon.png";
    ...
    <div className="Home-token-card-options">
      ...
      >
        ...
        >
          ...
          >
            <img src={utxLogo} alt="logo utx" style={{ width: "54px" }} />
            ...
            >
              <div className="fz-md fw-600 text-primary">NVX</div>
        ...
        <div className="Home-token-card-option-info">
          ...
          >
            <Trans>NVX is the utility and governance token. Accrues 30% of the platform's generated fees.</Trans>
          </div>
