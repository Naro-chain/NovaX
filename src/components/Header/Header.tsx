...
import logoImg from "img/logo-novax-desktop.png";
      ...
      <header>
        <div className="App-header large">
          <div className="App-header-container-left">
            <div className="App-header-logo-deals">
              <Link className="App-header-link-main" to="/">
                <img src={logoImg} className="big" alt="NVX Logo" />
                <img src={logoSmallImg} className="small" alt="NVX Logo" />
              </Link>
              <Deals />
            </div>
            {isHomeSite() ? (
